INSERT INTO dish(hash, top_image, title, description, n_price, s_price, section_name, stock) VALUES('H9881', 'https://cdn.bmf.kr/_data/product/H9881/910a01a81c49cb75414edb759237501f.jpg', '[소중한식사] 경상도 한상차림', '경상도 명물 요리 세 가지를 한 상에!', 39000, 31200, NULL, 10);
INSERT INTO dish(hash, top_image, title, description, n_price, s_price, section_name, stock) VALUES('HDF4C', 'imageurl', '[딩고] 시그니처 3종 SET', '오늘 저녁은 이상하게 안주빨을 세워보고 싶다!', 32800, 24000, NULL, 10);
INSERT INTO dish(hash, top_image, title, description, n_price, s_price, section_name, stock) VALUES('H7F20', 'imageurl', '[집밥의완성]초여름보양세트', '무더위에 대비하는 6월 한상차림 초여름 보양세트', 26000, 18200, NULL, 10);
...
INSERT INTO image(id, image_url, dish_hash) VALUES (1, 'https://cdn.bmf.kr/_data/product/HDF4C/a5f8637df5a375e3105c12b6efd47538.jpg','H9881');
INSERT INTO image(id, image_url, dish_hash) VALUES (2, 'https://cdn.bmf.kr/_data/product/HDF4C/6cca5e7533981795c6d9f2744bfc78c0.jpg','H9881');
INSERT INTO image(id, image_url, dish_hash) VALUES (3, 'https://cdn.bmf.kr/_data/product/HDF4C/a3972e617da696c157a8bef56fd3c277.jpg','H9881');
INSERT INTO image(id, image_url, dish_hash) VALUES (4, 'https://cdn.bmf.kr/_data/product/HDF4C/b68631d002e5302c7a3c3102cf429816.jpg','H9881');

INSERT INTO event(id, badge, dish_hash) VALUES (1, 'event', 'H9881');
INSERT INTO event(id, badge, dish_hash) VALUES (2, 'event', 'HDF4C');
INSERT INTO event(id, badge, dish_hash) VALUES (3, 'event', 'H7F20');

INSERT INTO event(id, badge, dish_hash) VALUES (4, 'event', 'HBDEF');
