INSERT INTO dish(hash, top_image, title, description, n_price, s_price, section_name, stock, badge) VALUES('H9881', 'https://cdn.bmf.kr/_data/product/H9881/910a01a81c49cb75414edb759237501f.jpg', '[소중한식사] 경상도 한상차림', '경상도 명물 요리 세 가지를 한 상에!', 39000, 31200, NULL, 10, '런칭특가');
INSERT INTO dish(hash, top_image, title, description, n_price, s_price, section_name, stock, badge) VALUES('HDF4C', 'imageurl', '[딩고] 시그니처 3종 SET', '오늘 저녁은 이상하게 안주빨을 세워보고 싶다!', 32800, 24000, NULL, 10., '런칭특가');
...
INSERT INTO dish(hash, top_image, title, description, n_price, s_price, section_name, stock, badge) VALUES('HBDEF', 'imageurl', '[미노리키친] 규동 250g', '일본인의 소울푸드! 한국인도 좋아하는 소고기덮밥', 6500, 5200, 'main,course', 10, '런칭특가,이벤트특가');

INSERT INTO dish(hash, top_image, title, description, n_price, s_price, section_name, stock, badge) VALUES('HDF73', 'imageurl', '[빅마마의밥친구] 아삭 고소한 연근고기조림 250g', '편식하는 아이도 좋아하는 건강한 연근조림', 0, 5500, 'main,soup', 10, '이벤트특가');
