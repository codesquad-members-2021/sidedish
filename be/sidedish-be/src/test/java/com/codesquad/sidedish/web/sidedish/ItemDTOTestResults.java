...
public class ItemDTOTestResults {
    public static final String MAIN_MENU = "[ {" + System.lineSeparator() +
            "  \"detail_hash\" : \"HBDEF\"," + System.lineSeparator() +
            "  \"image\" : \"https://cdn.bmf.kr/_data/product/HF56E/2d3f99a9a35601f4e98837bc4d39b2c8.jpg\"," + System.lineSeparator() +
            "  \"alt\" : \"[윤식당] 불고기 with Rice (재료)\"," + System.lineSeparator() +
            "  \"delivery_type\" : [ \"새벽배송\", \"전국택배\" ]," + System.lineSeparator() +
            "  \"title\" : \"[윤식당] 불고기 with Rice (재료)\"," + System.lineSeparator() +
            ...
            "  \"alt\" : \"[빅마마의밥친구] 아삭 고소한 연근고기조림 250g\"," + System.lineSeparator() +
            "  \"delivery_type\" : [ \"새벽배송\", \"전국택배\" ]," + System.lineSeparator() +
            "  \"title\" : \"[빅마마의밥친구] 아삭 고소한 연근고기조림 250g\"," + System.lineSeparator() +
            ...
            "  \"alt\" : \"[소중한식사] 골뱅이무침 195g\"," + System.lineSeparator() +
            "  \"delivery_type\" : [ \"새벽배송\", \"전국택배\" ]," + System.lineSeparator() +
            "  \"title\" : \"[소중한식사] 골뱅이무침 195g\"," + System.lineSeparator() +
            "  \"description\" : \"매콤새콤달콤, 반찬으로도 안주로도 좋은\"," + System.lineSeparator() +
            "  \"n_price\" : \"7,000원\"," + System.lineSeparator() +
            "  \"s_price\" : \"6,300원\"," + System.lineSeparator() +
            "  \"badge\" : [ \"이벤트특가\" ]" + System.lineSeparator() +
            "}, {" + System.lineSeparator() +
            "  \"detail_hash\" : \"HFB53\"," + System.lineSeparator() +
            "  \"image\" : \"https://cdn.bmf.kr/_data/product/HFB53/b6beada6b89af950289003d929936d9c.jpg\"," + System.lineSeparator() +
            "  \"alt\" : \"[옹가솜씨] 꽁치간장조림 240g\"," + System.lineSeparator() +
            "  \"delivery_type\" : [ \"새벽배송\", \"전국택배\" ]," + System.lineSeparator() +
            "  \"title\" : \"[옹가솜씨] 꽁치간장조림 240g\"," + System.lineSeparator() +
            ...
            "  \"alt\" : \"[마더앤찬] 코다리구이 320g\"," + System.lineSeparator() +
            "  \"delivery_type\" : [ \"새벽배송\", \"전국택배\" ]," + System.lineSeparator() +
            "  \"title\" : \"[마더앤찬] 코다리구이 320g\"," + System.lineSeparator() +
            "  \"description\" : \"큼지막하고 살집 많은 동태 한 마리로 만든 코다리구이입니다.\"," + System.lineSeparator() +
            "  \"n_price\" : \"7,500원\"," + System.lineSeparator() +
            "  \"s_price\" : \"6,750원\"," + System.lineSeparator() +
            "  \"badge\" : [ \"론칭특가\" ]" + System.lineSeparator() +
            "}, {" + System.lineSeparator() +
            "  \"detail_hash\" : \"H4665\"," + System.lineSeparator() +
            "  \"image\" : \"https://cdn.bmf.kr/_data/product/H4665/385f4106ac26f6e4fe7c640714f405a5.jpg\"," + System.lineSeparator() +
            "  \"alt\" : \"[남도애꽃] 반건조 문어조림 120g\"," + System.lineSeparator() +
            "  \"delivery_type\" : [ \"새벽배송\", \"전국택배\" ]," + System.lineSeparator() +
            "  \"title\" : \"[남도애꽃] 반건조 문어조림 120g\"," + System.lineSeparator() +
            ...
            "  \"alt\" : \"[마샐미디쉬] 매콤마늘쫑 해산물볶음 180g\"," + System.lineSeparator() +
            "  \"delivery_type\" : [ \"새벽배송\", \"전국택배\" ]," + System.lineSeparator() +
            "  \"title\" : \"[마샐미디쉬] 매콤마늘쫑 해산물볶음 180g\"," + System.lineSeparator() +
            "  \"description\" : \"탱글탱글한 새우와 오징어를 마늘쫑과 함께 매콤하게 볶아냈어요.\"," + System.lineSeparator() +
            "  \"n_price\" : \"6,900원\"," + System.lineSeparator() +
            "  \"s_price\" : \"6,210원\"," + System.lineSeparator() +
            "  \"badge\" : [ \"론칭특가\" ]" + System.lineSeparator() +
            "}, {" + System.lineSeparator() +
            "  \"detail_hash\" : \"HEDFB\"," + System.lineSeparator() +
            "  \"image\" : \"https://cdn.bmf.kr/_data/product/HEDFB/bc3b777115e8377a48c7bd762fe5fdc9.jpg\"," + System.lineSeparator() +
            "  \"alt\" : \"[빅마마의밥친구] 비빔오징어 150g\"," + System.lineSeparator() +
            "  \"delivery_type\" : [ \"새벽배송\", \"전국택배\" ]," + System.lineSeparator() +
            "  \"title\" : \"[빅마마의밥친구] 비빔오징어 150g\"," + System.lineSeparator() +
    ...
    public static final String COURSE_MENU = "[ {" + System.lineSeparator() +
            ...
            "  \"n_price\" : \"\"," + System.lineSeparator() +
            "  \"s_price\" : \"16,000원\"," + System.lineSeparator() +
            "  \"badge\" : [ ]" + System.lineSeparator() +
            "}, {" + System.lineSeparator() +
            ...
            "  \"n_price\" : \"10,600원\"," + System.lineSeparator() +
            "  \"s_price\" : \"10,000원\"," + System.lineSeparator() +
            "  \"badge\" : [ \"론칭특가\", \"이벤트특가\" ]" + System.lineSeparator() +
            "}, {" + System.lineSeparator() +
            ...
            "  \"n_price\" : \"13,900원\"," + System.lineSeparator() +
            "  \"s_price\" : \"12,500원\"," + System.lineSeparator() +
            "  \"badge\" : [ \"론칭특가\", \"이벤트특가\" ]" + System.lineSeparator() +
            "}, {" + System.lineSeparator() +
            ...
            "  \"n_price\" : \"16,000원\"," + System.lineSeparator() +
            "  \"s_price\" : \"13,600원\"," + System.lineSeparator() +
            "  \"badge\" : [ \"이벤트특가\" ]" + System.lineSeparator() +
            "}, {" + System.lineSeparator() +
            ...
            "  \"n_price\" : \"12,800원\"," + System.lineSeparator() +
            "  \"s_price\" : \"9,900원\"," + System.lineSeparator() +
            "  \"badge\" : [ \"이벤트특가\" ]" + System.lineSeparator() +
            "}, {" + System.lineSeparator() +
            "  \"detail_hash\" : \"HBDEF\"," + System.lineSeparator() +
            "  \"image\" : \"https://cdn.bmf.kr/_data/product/HBDEF/4a2d8bbe9fb468b536861140a9beda61.jpg\"," + System.lineSeparator() +
    ...
    public static final String SOUP_MENU = "[ {" + System.lineSeparator() +
            ...
            "  \"n_price\" : \"15,000원\"," + System.lineSeparator() +
            "  \"s_price\" : \"14,200원\"," + System.lineSeparator() +
            "  \"badge\" : [ \"이벤트특가\" ]" + System.lineSeparator() +
            "}, {" + System.lineSeparator() +
            ...
            "  \"n_price\" : \"\"," + System.lineSeparator() +
            "  \"s_price\" : \"14,000원\"," + System.lineSeparator() +
            "  \"badge\" : [ ]" + System.lineSeparator() +
            "}, {" + System.lineSeparator() +
            ...
            "  \"n_price\" : \"5,500원\"," + System.lineSeparator() +
            "  \"s_price\" : \"4,300원\"," + System.lineSeparator() +
            "  \"badge\" : [ \"이벤트특가\" ]" + System.lineSeparator() +
            "}, {" + System.lineSeparator() +
            ...
            "  \"n_price\" : \"19,800원\"," + System.lineSeparator() +
            "  \"s_price\" : \"10,000원\"," + System.lineSeparator() +
            "  \"badge\" : [ \"이벤트특가\" ]" + System.lineSeparator() +
            "}, {" + System.lineSeparator() +
            ...
            "  \"n_price\" : \"18,000원\"," + System.lineSeparator() +
            "  \"s_price\" : \"14,400원\"," + System.lineSeparator() +
            "  \"badge\" : [ \"론칭특가\", \"이벤트특가\" ]" + System.lineSeparator() +
            "}, {" + System.lineSeparator() +
            ...
            "  \"n_price\" : \"5,900원\"," + System.lineSeparator() +
            "  \"s_price\" : \"4,400원\"," + System.lineSeparator() +
            "  \"badge\" : [ \"론칭특가\" ]" + System.lineSeparator() +
            "}, {" + System.lineSeparator() +
    ...
    public static final String SIDE_MENU = "[ {" + System.lineSeparator() +
            "  \"detail_hash\" : \"H72C3\"," + System.lineSeparator() +
            "  \"image\" : \"https://cdn.bmf.kr/_data/product/H72C3/d1fccf125f0a78113d0e06cb888f2e74.jpg\"," + System.lineSeparator() +
            "  \"alt\" : \"[수하동] 특곰탕 850g\"," + System.lineSeparator() +
            "  \"delivery_type\" : [ \"새벽배송\", \"전국택배\" ]," + System.lineSeparator() +
