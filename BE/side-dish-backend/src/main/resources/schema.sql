...
('베트남 곱창 쌀국수','베트남의 그맛과 감동을 그대로 쌀국수',4000,3300,'BEST'),
('할머니의 멸치국수','할머니의 손맛 멸치국수',2000,1900,'BEST'),
('왕큰만두','왕크니까 왕맛있는 왕큰만두',10000,9300,'BEST'),
('서해간장개장','서해의 크고 알흠다운 꽃게들로 가득찬 간장게장',40000,39300,'BEST'),
...
('전복전복죽','전복죽 너무 사랑해 늘 새로워 짜릿해',10000,9300,'SOUP'),
('유기농 친환경 당근쥬스','건강을 위해서 참고 먹어요 친환경 당근주스',20000,19300,'SOUP'),
('한국인의 김치','김치는 한국인들을 위한 필수요소',8800,7000,'SOUP'),
('견과류선물셋트','선물은 역시나 편한 견과류가 최고야',20000,19300,'SOUP'),


('곰곰 우유식짱',' ',10000,1900,'SIDE'),
('추억과 공포의 옜날꿀호떡',' ',10000,8800,'SIDE'),
('생크림 카스테라',' ',40000,29300,'SIDE'),
('오븐에 구운 도나쓰',' ',70000,63500,'SIDE'),
('햄버거',' ',5500,5000,'SIDE');
