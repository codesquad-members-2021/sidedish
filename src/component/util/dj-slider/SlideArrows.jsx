...
import { usePageContext } from "./DicoJsonSlider";
...
export default function SlideArrows({ onMovePage, loop, maxPage }) {
  const page = usePageContext();
  return (
    <SlideArrowsStyle>
      <SlideLeftArrow onClick={() => onMovePage(-1)} active={loop || page > 1}>
        <FaChevronLeft />
      </SlideLeftArrow>
      <SlideRightArrow
